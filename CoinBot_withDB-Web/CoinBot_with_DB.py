...
LongStrategyCoin = ["KRW-IQ","KRW-SRM","KRW-SAND","KRW-XEM"] ; Forbidden_Coin = ['KRW-ETH', 'KRW-BTC', 'KRW-BTT', 'KRW-XEC']
total = 60000
left = 60000
# K값, 동시 구매 가능한 코인 개수
K_value = 0.3
